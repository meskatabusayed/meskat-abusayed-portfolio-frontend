            ...
            >
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="inline-block text-blue-400 font-semibold hover:bg-blue-500 hover:text-white py-2 px-4 rounded transition duration-300 ease-in-out shadow-md transform hover:scale-105"
                >
                  Read More →
                </a>
              </div>
